 ...
 */
    menus(a,b,c) {
    _.$(`#container-${a}-closed`).addEventListener('click', e => {
        openMenu(a)
...
function tags(el,menuColor) {
    ...
    elementLi.addEventListener('click', e => {
        const button = _.createEltWithClassName('button', 'nav__selected__container__tagSelected')
        button.textContent = el
        const closeIcon = _.createEltWithClassName('i','far','fa-times-circle','nav__selected__container__close')
